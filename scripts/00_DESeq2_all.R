...
dir.create("outputs/DESeq2", showWarnings = FALSE, recursive = TRUE)
dir.create("figures/PCA", showWarnings = FALSE, recursive = TRUE)
...
for (geo_id in geo_ids) {
  ...
  count_file <- paste0("data/", geo_id, "_raw_counts.tsv")
  if (!file.exists(count_file)) {
    count_file <- paste0("data/", geo_id, "_raw_counts.csv")
  }
  ...
  output_file <- paste0("outputs/DESeq2/", geo_id, ".csv")
  ...
  pca_dir <- paste0("figures/PCA/", geo_id)
