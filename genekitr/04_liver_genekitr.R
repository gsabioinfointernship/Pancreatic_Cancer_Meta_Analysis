...
dir.create("outputs/liver/annotated", showWarnings = FALSE, recursive = TRUE)
...
for (geo_id in geo_ids) {
  ...
  input_file <- paste0("outputs/liver/DESeq2/", geo_id, ".csv")
  ...
  output_file <- paste0("outputs/liver/annotated/", geo_id, ".csv")
