...
dir.create("outputs/kidney/annotated", showWarnings = FALSE, recursive = TRUE)
...
for (geo_id in geo_ids) {
  ...
  input_file <- paste0("outputs/kidney/DESeq2/", geo_id, ".csv")
  ...
  output_file <- paste0("outputs/kidney/annotated/", geo_id, ".csv")
