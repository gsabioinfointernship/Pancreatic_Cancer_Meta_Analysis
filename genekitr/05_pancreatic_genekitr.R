...
dir.create("outputs/pancreatic/annotated", showWarnings = FALSE, recursive = TRUE)
...
for (geo_id in geo_ids) {
  ...
  input_file <- paste0("outputs/pancreatic/DESeq2/", geo_id, ".csv")
  ...
  output_file <- paste0("outputs/pancreatic/annotated/", geo_id, ".csv")
